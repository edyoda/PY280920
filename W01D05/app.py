...
# import package
# from package import mod4
# print(mod3.ibm("make us an Quantum Computer"))

# print(mod4.tesla("lets go to a different galaxy!!"))


# from package.subpackage import mod4
# print(mod4.tesla("lets go to a different galaxy!!"))

# from package.subpackage.subsubpackage import mod1

# print(mod1.pipi)

# from test_package.subpackage import module2

# print(module2.xyz(45))

from test_package import module1


# from test_package import utilitycode
# print(utilitycode.pi)

print(module1.userfun(7.6))
